...
In order to load this data into an Azure notebook, you need to know how to read files in Python.
...
Now let's use what you learned to open **airports.csv** and read its contents into a list  in your Azure notebook.
...
The data file has been uploaded to Azure Notebooks and loaded into your notebook, but right now it's nothing more than a list of strings containing airport codes, locations, and names. The strings need to be parsed to extract information regarding individual airports. That's the subject of the next lesson.