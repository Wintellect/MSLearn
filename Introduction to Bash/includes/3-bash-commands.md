...
If **kitty.jpg** already exists, Bash cheerfully and silently replaces the older one with the copy. That's great if that's what you intended, but not so wonderful if you didn't realize you just overwrote the old version. 
